...
Difficulty rises continuously through higher arrow-count targets, denser silhouette coverage, longer paths, more turns, tighter grids, and deeper removal dependencies. Boss difficulty also scales with the boss number: later bosses target up to 76 arrows and longer paths, while lives fall from three to one and hints fall from two to none.
